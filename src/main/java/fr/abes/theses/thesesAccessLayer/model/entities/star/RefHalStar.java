...
@NoArgsConstructor
@Getter @Setter
public class RefHalStar implements Serializable, GenericEntity<Integer> {
    @Id
    @Column(name = "IDLABO")
    Integer idLabo;
    ...
    public RefHalStar(Integer idLabo, String snameLabo, String nameLabo, String urlLabo, String paysLabo, String statusLabo) {
        this.idLabo = idLabo;
