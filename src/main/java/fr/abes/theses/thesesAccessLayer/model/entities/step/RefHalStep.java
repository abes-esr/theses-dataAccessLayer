...
@NoArgsConstructor
@Getter @Setter
public class RefHalStep implements Serializable, GenericEntity<Integer> {
    @Id
    @Column(name = "IDLABO")
    Integer idLabo;
    ...
    public RefHalStep(Integer idLabo, String snameLabo, String nameLabo, String urlLabo, String paysLabo, String statusLabo) {
        this.idLabo = idLabo;
